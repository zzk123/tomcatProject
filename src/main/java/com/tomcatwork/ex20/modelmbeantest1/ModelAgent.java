...
public class ModelAgent {
    ...
    private String MANAGED_CLASS_NAME = "com.tomcatwork.ex20.modelmbeantest1.Car";
    ...
    private ModelMBeanInfo createModelMBeanInfo(ObjectName inMbeanObjectName, String inMbeanName){
        ...
        try{
            ...
            mBeanInfo = new ModelMBeanInfoSupport(MANAGED_CLASS_NAME, null, attributeInfos, null,
                    operations, null);
        }catch (Exception e){
            e.printStackTrace();
        }
